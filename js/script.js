...
function diceRoll(array) {
   let i = Math.ceil(Math.random() * array.length);
   //console.log('this is the random number: '+i);
   return i;
 }
...
playBtn.addEventListener('click', () => {
  ...
  // 5) Log out the two variables above to test their values — check them out in the console
    console.log('This is the score for player one: '+playerOneScore);
    console.log('This is the score for player two: '+playerTwoScore);
...
/*
    let scoreOneElement = document.getElementById('score-1');
    let scoreTwoElement = document.getElementById('score-2');
